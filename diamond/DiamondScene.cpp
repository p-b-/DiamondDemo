...
bool DiamondScene::Initialise(Textures* pTextureCtrl, Window* pWnd) {
...
void DiamondScene::InitialiseCamera(Window* pWnd, glm::vec3 vecPos) {
...
void DiamondScene::ProcessDigitalAction(unsigned int unAction, float fDeltaTime) {
    ProcessDigitalAction((SceneAction)unAction, fDeltaTime);
}

void DiamondScene::ProcessAnalogAction(unsigned int unAction, float fAnalogValue, float fDeltaTime) {
    ProcessAnalogAction((SceneAction)unAction, fAnalogValue, fDeltaTime);
}

void DiamondScene::ProcessAnalogAction(unsigned int unAction, float fAnalogValue1, float fAnalogValue2, float fDeltaTime) {
    ProcessAnalogAction((SceneAction)unAction, fAnalogValue1, fAnalogValue2, fDeltaTime);
}

void DiamondScene::ProcessAnalogAction(unsigned int unAction, float fAnalogValue1, float fAnalogValue2, float fAnalogValue3, float fDeltaTime) {
    ProcessAnalogAction((SceneAction)unAction, fAnalogValue1, fAnalogValue2, fAnalogValue3, fDeltaTime);
}
